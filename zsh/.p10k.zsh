source ~/dotfiles/zsh/omarchy-p10k-colors.zsh
# Generated by Powerlevel10k configuration wizard on 2025-01-06 at 08:33 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=$OMARCHY_SURFACE
